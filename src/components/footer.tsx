        ...
        <footer className="footer">
          <div className="inner">
            ...
            <ul className="copyright">
              ...
              <li><a href={metadata.siteSources} className="icon alt fa-github fa-xs" target="_blank" rel="noreferrer" title="DeveloPassion's Website sources"/>
              </li>
              <li><a href={metadata.social.twitterSebastien} target="_blank" rel="noreferrer" title="dSebastien @ Twitter">dSebastien</a></li>
