                ...
                <div className="inner">
                    ...
                    <div className="grid-wrapper">
                        ...
                        <div className="col-6">
                                ...
                                <h4>Fit</h4>
                                <span className="image fit"><img src={alone} alt="" /></span>
                                <div className="box alt">
                                    <div className="grid-wrapper">
                                        <div className="col-4"><span className="image fit"><img src={alone} alt="" /></span></div>
                                        <div className="col-4"><span className="image fit"><img src={data} alt="" /></span></div>
                                        <div className="col-4"><span className="image fit"><img src={architecture} alt="" /></span></div>
                                        <div className="col-4"><span className="image fit"><img src={architecture} alt="" /></span></div>
                                        <div className="col-4"><span className="image fit"><img src={alone} alt="" /></span></div>
                                        <div className="col-4"><span className="image fit"><img src={data} alt="" /></span></div>
                                        <div className="col-4"><span className="image fit"><img src={data} alt="" /></span></div>
